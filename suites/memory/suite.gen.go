...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/memory?ref=14af90ed1f8ca61ee0f1d0285c9df1d0bb6619e6`)
...
func (s *Suite) TestKernel2ethernet2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/memory/Kernel2Ethernet2Kernel?ref=14af90ed1f8ca61ee0f1d0285c9df1d0bb6619e6`)
...
func (s *Suite) TestKernel2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/memory/Kernel2Kernel?ref=14af90ed1f8ca61ee0f1d0285c9df1d0bb6619e6`)
...
func (s *Suite) TestMemif2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/memory/Memif2Memif?ref=14af90ed1f8ca61ee0f1d0285c9df1d0bb6619e6`)
