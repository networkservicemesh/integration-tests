...
func (s *Suite) TestKernel2ethernet2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=ef9143be09b86ee0ce6b8ed2426d1e82e4ffa7ba`)
...
func (s *Suite) TestKernel2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=ef9143be09b86ee0ce6b8ed2426d1e82e4ffa7ba`)
...
func (s *Suite) TestSriovkernel2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=ef9143be09b86ee0ce6b8ed2426d1e82e4ffa7ba`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=ef9143be09b86ee0ce6b8ed2426d1e82e4ffa7ba`)
...
func (s *Suite) TestVfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Vfio2Noop?ref=ef9143be09b86ee0ce6b8ed2426d1e82e4ffa7ba`)
