...
func (s *Suite) TestKernel2ethernet2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=f8f432f16bb89e60f8b56285555c4d8dd8308525`)
...
func (s *Suite) TestKernel2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=f8f432f16bb89e60f8b56285555c4d8dd8308525`)
...
func (s *Suite) TestSriovkernel2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=f8f432f16bb89e60f8b56285555c4d8dd8308525`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=f8f432f16bb89e60f8b56285555c4d8dd8308525`)
...
func (s *Suite) TestVfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Vfio2Noop?ref=f8f432f16bb89e60f8b56285555c4d8dd8308525`)
