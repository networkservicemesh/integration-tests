...
func (s *Suite) TestKernel2ethernet2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=b1a14cbbde148db7c23bdb0e69b840fbf66d5502`)
...
func (s *Suite) TestKernel2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=b1a14cbbde148db7c23bdb0e69b840fbf66d5502`)
...
func (s *Suite) TestSriovkernel2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=b1a14cbbde148db7c23bdb0e69b840fbf66d5502`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=b1a14cbbde148db7c23bdb0e69b840fbf66d5502`)
...
func (s *Suite) TestVfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Vfio2Noop?ref=b1a14cbbde148db7c23bdb0e69b840fbf66d5502`)
