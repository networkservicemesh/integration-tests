...
func (s *Suite) TestKernel2ethernet2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2kernel_vfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestSriovkernel2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestVfio2noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Vfio2Noop?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
