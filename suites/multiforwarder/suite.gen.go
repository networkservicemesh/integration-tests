...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/multiforwarder`)
}
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/use-cases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`NODE=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}')[0])`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-vfio` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-vfio` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nsc.yaml` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/use-cases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-kernel-ponger` + "\n" + `` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nsc.yaml` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
