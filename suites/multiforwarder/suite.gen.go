...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=2beac0ed8483f33ed5bf6f1a398991f5037ec4c8`)
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=2beac0ed8483f33ed5bf6f1a398991f5037ec4c8`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=2beac0ed8483f33ed5bf6f1a398991f5037ec4c8`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=2beac0ed8483f33ed5bf6f1a398991f5037ec4c8`)
...
func (s *Suite) TestVfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Vfio2Noop?ref=2beac0ed8483f33ed5bf6f1a398991f5037ec4c8`)
