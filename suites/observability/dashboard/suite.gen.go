...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/apps/dashboard`)
	r.Run(`kubectl wait --for=condition=ready pod -l app=dashboard --timeout=300s -n nsm-system`)
