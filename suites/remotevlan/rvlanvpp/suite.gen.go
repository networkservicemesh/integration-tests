...
func (s *Suite) SetupSuite() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
	})
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	s.T().Cleanup(func() {
		r.Run(`docker stop rvm-tester && \` + "\n" + `docker image rm rvm-tester:latest` + "\n" + `true`)
		r.Run(`kubectl delete --namespace=nsm-system -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
		r.Run(`kubectl delete ns ns-kernel2vlan-multins-1`)
		r.Run(`kubectl delete ns ns-kernel2vlan-multins-2`)
	})
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca`)
	r.Run(`kubectl apply -n nsm-system -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ef87c6a861c5ceeb47eb511bd05cdb3683ad07ca/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
