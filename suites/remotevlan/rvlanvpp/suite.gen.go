...
func (s *Suite) SetupSuite() {
	...
	r := s.Runner("/home/nikita/repos/NSM/deployments-k8s/examples/remotevlan/rvlanvpp")
	s.T().Cleanup(func() {
		r.Run(`kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=5a9bdf42902474b17fea95ab459ce98d7b5aa3d0`)
	})
