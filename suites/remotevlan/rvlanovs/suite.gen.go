...
func (s *Suite) SetupSuite() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanovs?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
	})
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanovs?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	s.T().Cleanup(func() {
		r.Run(`docker stop rvm-tester && \` + "\n" + `docker image rm rvm-tester:latest` + "\n" + `true`)
		r.Run(`kubectl delete --namespace=nsm-system -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000`)
	r.Run(`kubectl apply -n nsm-system -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/64a16ee0d36880a0d3c879b8d4cbb4f40cb1f000/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
