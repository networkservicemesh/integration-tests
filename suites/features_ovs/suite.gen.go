...
func (s *Suite) TestWebhook_smartvf() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/webhook-smartvf?ref=5daa5f2af0e4c59834818d93bd819dd6aa017729`)
