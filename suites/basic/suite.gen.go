...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestKernel2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestKernel2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Vxlan2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestKernel2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Vxlan2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestKernel2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Wireguard2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestKernel2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Wireguard2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Vxlan2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Vxlan2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Wireguard2Kernel?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
...
func (s *Suite) TestMemif2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Wireguard2Memif?ref=c1950893f477d7cf35a9edb355fd2c60ced9c007`)
