...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestKernel2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestKernel2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Vxlan2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestKernel2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Vxlan2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestKernel2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Wireguard2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestKernel2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Wireguard2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Vxlan2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Vxlan2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Vxlan2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Vxlan2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Wireguard2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Wireguard2Kernel?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
...
func (s *Suite) TestMemif2Wireguard2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Wireguard2Memif?ref=ca05fbdcd0931d17cbc187fe203a66b3d6840196`)
