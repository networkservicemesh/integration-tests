...
func (s *Suite) TestKernel2ethernet2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestKernel2ethernet2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestKernel2ip2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2IP2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestKernel2ip2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2IP2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestKernel2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestKernel2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2ethernet2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Ethernet2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2ethernet2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Ethernet2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2ip2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2IP2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2ip2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2IP2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Kernel?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
...
func (s *Suite) TestMemif2memif() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Memif?ref=0db218c9df2e4fa3faf5367f51a2495950c76d80`)
