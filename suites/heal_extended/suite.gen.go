...
func (s *Suite) TestComponent_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/heal_extended/component-restart?ref=e95991321aa11e515fb2ef6bcc6143120ca7e146`)
