...
func (s *Suite) SetupSuite() {
	...
	r := s.Runner("/home/nikita/repos/NSM/deployments-k8s/examples/multiforwarder_vlantag")
	s.T().Cleanup(func() {
...
func (s *Suite) Kernel2Ethernet2Kernel_Vfio2NoopVlanTag(t *testing.T) {
	r := s.Runner("/home/nikita/repos/NSM/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag")
	t.Cleanup(func() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag?ref=5a9bdf42902474b17fea95ab459ce98d7b5aa3d0`)
...
func (s *Suite) Kernel2Kernel_Vfio2NoopVlanTag(t *testing.T) {
	r := s.Runner("/home/nikita/repos/NSM/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2NoopVlanTag")
	t.Cleanup(func() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2NoopVlanTag?ref=5a9bdf42902474b17fea95ab459ce98d7b5aa3d0`)
