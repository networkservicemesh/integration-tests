...
func (s *Suite) SetupSuite() {
	...
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e5fab684916701d0f8bec2aca522ceb4229ac6a0/examples/interdomain/dns/service.yaml`)
	r.Run(`export KUBECONFIG=$KUBECONFIG2`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e5fab684916701d0f8bec2aca522ceb4229ac6a0/examples/interdomain/dns/service.yaml`)
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e5fab684916701d0f8bec2aca522ceb4229ac6a0/examples/interdomain/dns/service.yaml`)
