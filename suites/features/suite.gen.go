...
func (s *Suite) TestDns() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	...
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-kernel` + "\n" + `` + "\n" + `resources:` + "\n" + `- dnsutils.yaml` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/dns/coredns-config-map.yaml` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/use-cases/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	...
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-kernel` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nsc.yaml` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
func (s *Suite) TestKernel2Wireguard2Memif() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`NODES=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}'))`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `resources: ` + "\n" + `- client.yaml` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-memif` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
	r.Run(`cat > client.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: v1` + "\n" + `kind: Pod` + "\n" + `metadata:` + "\n" + `  name: alpine` + "\n" + `  labels:` + "\n" + `    app: alpine    ` + "\n" + `  annotations:` + "\n" + `    networkservicemesh.io: kernel://icmp-responder-ip/nsm-1` + "\n" + `spec:` + "\n" + `  containers:` + "\n" + `  - name: alpine` + "\n" + `    image: alpine` + "\n" + `    imagePullPolicy: IfNotPresent` + "\n" + `    stdin: true` + "\n" + `    tty: true` + "\n" + `  nodeSelector:` + "\n" + `    kubernetes.io/hostname: ${NODES[0]}` + "\n" + `EOF`)
	r.Run(`cat > patch-nse.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: apps/v1` + "\n" + `kind: Deployment` + "\n" + `metadata:` + "\n" + `  name: nse-memif` + "\n" + `spec:` + "\n" + `  template:` + "\n" + `    spec:` + "\n" + `      containers:` + "\n" + `        - name: nse` + "\n" + `          env:` + "\n" + `            - name: NSM_CIDR_PREFIX` + "\n" + `              value: 2001:db8::/116` + "\n" + `            - name: NSM_PAYLOAD` + "\n" + `              value: IP` + "\n" + `            - name: NSM_SERVICE_NAMES` + "\n" + `              value: icmp-responder-ip` + "\n" + `      nodeSelector:` + "\n" + `        kubernetes.io/hostname: ${NODES[1]}` + "\n" + `EOF`)
	r.Run(`kubectl apply -k .`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`NODE=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}')[0])`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-memif` + "\n" + `- ../../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-memif` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nsc.yaml` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`NAMESPACE=($(kubectl create -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/namespace.yaml)[0])` + "\n" + `NAMESPACE=${NAMESPACE:10}`)
	r.Run(`NODE=($(kubectl get nodes -o go-template='{{range .items}}{{ if not .spec.taints  }}{{index .metadata.labels "kubernetes.io/hostname"}} {{end}}{{end}}')[0])`)
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `namespace: ${NAMESPACE}` + "\n" + `` + "\n" + `resources:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/config-file.yaml` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/passthrough-1.yaml` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/passthrough-2.yaml` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/passthrough-3.yaml` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/nse-composition-ns.yaml` + "\n" + `- client.yaml` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-kernel` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/nse-composition/nse-firewall` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nse.yaml` + "\n" + `EOF`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`cat > kustomization.yaml <<EOF` + "\n" + `---` + "\n" + `apiVersion: kustomize.config.k8s.io/v1beta1` + "\n" + `kind: Kustomization` + "\n" + `` + "\n" + `namespace: $NAMESPACE` + "\n" + `` + "\n" + `bases:` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nse-supplier-k8s` + "\n" + `- ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/apps/nsc-kernel` + "\n" + `` + "\n" + `patchesStrategicMerge:` + "\n" + `- patch-nsc.yaml` + "\n" + `- patch-supplier.yaml` + "\n" + `` + "\n" + `configMapGenerator:` + "\n" + `  - name: supplier-pod-template-configmap` + "\n" + `    files:` + "\n" + `      - ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/scale-from-zero/pod-template.yaml` + "\n" + `EOF`)
	r.Run(`kubectl apply -f ../../../../../../../../../../Users/user/Documents/dev/nsm/deployments-k8s/examples/features/scale-from-zero/autoscale-netsvc.yaml`)
	r.Run(`kubectl apply -k .`)
