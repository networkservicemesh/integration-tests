...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/fa884d7fc02955ed77798d4b95bd12caa5a366b5/examples/features/annotated-namespace/client.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dns?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2ip2kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes-client?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2ip2kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2ip2memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestKernel2kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestMemif2ip2kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestMemif2ip2memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestMemif2memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestMultiple_services() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/multiple-services?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/mutually-aware-nses?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/nse-composition?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/opa?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/policy-based-routing?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scale-from-zero?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/select-forwarder?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-basic?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-scale-from-zero?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/webhook?ref=fa884d7fc02955ed77798d4b95bd12caa5a366b5`)
