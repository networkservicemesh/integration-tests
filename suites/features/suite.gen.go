...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/cec341dff73f761d80d292ad6e5805c254e8f077/examples/features/annotated-namespace/client.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dns?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes-client?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestMultiple_services() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/multiple-services?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/mutually-aware-nses?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/nse-composition?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/opa?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/policy-based-routing?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scale-from-zero?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/select-forwarder?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-basic?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestVl3_lb() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-lb?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-scale-from-zero?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/webhook?ref=cec341dff73f761d80d292ad6e5805c254e8f077`)
