...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bcd4f3164285151c3872334dc3609bdbba982faf/examples/features/annotated-namespace/client.yaml`)
...
func (s *Suite) TestChange_nse_dynamically() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bcd4f3164285151c3872334dc3609bdbba982faf/examples/features/change-nse-dynamically/blue-netsvc.yaml`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bcd4f3164285151c3872334dc3609bdbba982faf/examples/features/change-nse-dynamically/green-netsvc.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dns?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes-client?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestMultiple_services() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/multiple-services?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/mutually-aware-nses?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/nse-composition?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/opa?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/policy-based-routing?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scale-from-zero?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestScaled_registry() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/scaled-registry?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/select-forwarder?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestVl3_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-ipv6?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestVl3_lb() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-lb?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-scale-from-zero?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/webhook?ref=bcd4f3164285151c3872334dc3609bdbba982faf`)
